...
public class ForkedXASessionImpl extends SessionImpl implements XASession, XAResource {
     ...
     * Logger instance
     */
    private static final Logger log = LoggerFactory.getLogger(ForkedXASessionImpl.class);
    ...
    public boolean isSameRM(XAResource xares) throws XAException {
        if (xares instanceof ForkedXASessionImpl) {
            ForkedXASessionImpl xases = (ForkedXASessionImpl) xares;
