...
public class ServicingNodeIndexerTest extends TestCase {
    ...
    public void testNotSpecialProperty() throws RepositoryException {
        ...
        query = queryManager.createQuery("//*[@sample:normal] order by @sample:normal descending", Query.XPATH);
        final QueryResult descendingResult = query.execute();

        query = queryManager.createQuery("//*[@sample:normal] order by @sample:normal ascending", Query.XPATH);
